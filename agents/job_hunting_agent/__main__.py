...
def main(host: str = DEFAULT_HOST, port: int = DEFAULT_PORT):
    ...
    skill = AgentSkill(
        id='job_hunting',
        name='Search and filter job opportunities',
        description='Helps with finding and filtering job opportunities in Czech Republic',
        tags=['jobs', 'career'],
    ...
    adk_agent = create_job_hunting_agent()
    runner = Runner(
    ...
    agent_executor = JobHuntingAgentExecutor(adk_agent, agent_card, runner)

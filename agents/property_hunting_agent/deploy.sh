...
# Deployment script for property-hunting-agent Cloud Run service
...
echo ""
echo "🚀 Deploying property-hunting-agent to Cloud Run"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
GCLOUD_CMD="gcloud run deploy property-hunting-agent \
    --source $SCRIPT_DIR \
    --port=8080 \
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "🔗 Service URL:"
    gcloud run services describe property-hunting-agent \
        --region=$REGION \
        --project=$PROJECT_ID \
